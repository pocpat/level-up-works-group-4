...
const SignupStudent = (props) => {
  ...
  //  ==== collect all inputs ====
  const [inputSignUpStudent, setInputSignUpStudent] = useState({});
...
// == handle all user inputs at once  ==
  function handleUserInput(e) {
    ...
    setInputSignUpStudent((prevState) => {
      return {
        ...prevState,
  ...
  const handleSignup = (e) => {
    ...
    axios
      .post("http://localhost:4000/signup/student", inputSignUpStudent)
      .then((data) => {
...
{/* name input */}
 ...
 {/* button Signup */}
        <button type="submit" onClick={handleSignup} name="signupStudent">
          SIGN UP
        </button>
      </div>
    </div>
